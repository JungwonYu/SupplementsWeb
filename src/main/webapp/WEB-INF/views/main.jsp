			...
			<div class="carousel-inner">
				<div class="carousel-item active" style="background-image: url('https://images.unsplash.com/photo-1610021685640-830eff58c1dd?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1840&q=80/1920x1080')">
					<div class="carousel-caption">
						<p class="display-4">나에게 지금 필요한 영양제는 무엇일까요?</p>
				...
				<div class="carousel-item" style="background-image: url('https://images.unsplash.com/photo-1627467959547-8e44da7aa00a?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1074&q=80/1920x1080')">
					<div class="carousel-caption">
                        <p class="display-4">광고가 아닌 영양제 후기를 알고 싶어요!</p>
						<p>세모에는 회원들이 소통할 수 있는 게시판이 있어요!</p>
					</div>
				</div>
				<div class="carousel-item" style="background-image: url('https://images.unsplash.com/photo-1611073061835-e77b1b16d3f3?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1171&q=80/1920x1080')">
					<div class="carousel-caption">
						<h5>영양제에 대한 질문을 하고 싶어요!</h5>
						<p>세모에는 Q&A 게시판이 있어요! 지금 질문을 남겨보세요.</p>
					</div>
				</div>
			</div>
        ...
        <div class="container px-5">
            <div class="row gx-5 justify-content-center">
                <div class="col-xl-8">
                    ...
                    <a class="btn btn-outline-light py-3 px-4 rounded-pill" href="bbs2"><i class="fas fa-users"></i>
                        　소통하기</a>
                </div>
            </div>
        </div>
            ...
            <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                <div class="col-12 col-lg-6">
                    <div class="context-media">
                        <img src="https://imgnews.pstatic.net/image/296/2021/11/04/0000052565_001_20211104213201532.png?type=w647"
                             style="height: 300px"/>
                    </div>
                    <h4 class="font-alt">내가 살찌는 이유 ‘잠’ 때문이었나?</h4>
                    <hr>
                    <p class="lead fw-normal text-muted mb-5 mb-lg-0">수면 장애란 건강한 수면을 못 하거나, 충분한 자는데도 낮에 각성을 유지하지 못하는 상태,
                        수면리듬이 흐트러져 있어서 깨어 있을 때 어려움을 겪는 상태를 말한다.</p>
                    <a class="btn btn-outline-dark py-1 px-2 rounded-pill" style="float: right;" href="newsVideo"><i
                            class="fas fa-angle-right"></i>　더보기</a>
                </div>
                <div class="col-12 col-lg-6">
                    <div class="context-media">
                        <iframe width="500" height="280" src="https://www.youtube.com/embed/Vtcbsu0tBaY"
                    ...
                    <hr>
                    <p class="lead fw-normal text-muted mb-5 mb-lg-0">영양제 최고의 궁합과 최악의 궁합은 무엇? 종합비타민, 오메가3, 칼슘, 비타민C는 어떤
                        영양제랑 같이 먹으면 더 좋을까요?<br>#영양제 #영양제궁합 #종합비타민</p>
                    <a class="btn btn-outline-dark py-1 px-2 rounded-pill" style="float: right;" href="newsVideo"><i
                            class="fas fa-angle-right"></i>　더보기</a>
                </div>
            </div>
    ...
    <section class="cta">
        <div class="cta-content">
            <div class="container px-5">
                ...
                <a class="btn btn-outline-light py-3 px-4 rounded-pill" href="infoENS"><i
                        class="fas fa-eye"></i>　알아보기</a>
            </div>
        </div>
    </section>
    <!--/영양제 소개 - infoENS 페이지로 이동-->
        ...
        <div class="container px-5">
            <div class="row gx-5 justify-content-center">
                <div class="col-xl-8">
                    ...
                    <a class="btn btn-outline-light py-3 px-4 rounded-pill" href="bbs"><i class="far fa-keyboard"></i>　후기
                        남기기</a>
                </div>
            </div>
        </div>
