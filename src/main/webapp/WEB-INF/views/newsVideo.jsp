				...
				<table class="table table-striped">
					...
					<tr>
						<td class="table-secondary">
							<iframe src="childNews" height="1150" width="600" frameborder=0 framespacing=0
									marginheight=0 marginwidth=0 marginleft=100px; scrolling=yes vspace=0>>
							</iframe>
						</td>
						<td class="table-secondary">
							<iframe src="childVideo" height="1150" width="600" frameborder=0 framespacing=0
									marginheight=0 marginwidth=0 scrolling=yes vspace=0>>
							</iframe>
						</td>
					</tr>
					</tbody>
