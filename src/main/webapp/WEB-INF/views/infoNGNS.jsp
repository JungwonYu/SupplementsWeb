...
<body>
	...
	<div class="container mb-5">
        ...
        <div class="row">
            <div class="col-md-7">
                <a href="#">
                    <img class="img-fluid rounded mb-3 mb-md-0" src="/images/infoNGNS.jpg" alt="">
                </a>
            </div>
            <div class="col-md-5">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <p>항생제는 균을 죽이는 역할을 하기 때문에 균의 한 종류인 유산균과 함께 섭취하면 유산균이 죽는다. 따라서 따로 아침에 공복에 유산균을 섭취하고 식사 후에 항생제를 섭취하는 것을
                    권장한다.</p>
                <a class="btn btn-primary float-xl-end" href="#">더보기</a>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <p>함량에 따라 다르지만, 비타민A와 루테인을 모두 고함량으로 섭취하면 비타민A 과잉 상태가 될 수 있다. 비타민A 과잉 상태가 되면 구토·두통·설사 증상이 나타날 수 있다. 루테인이
                    비타민A의 일종이기 때문이다. 이외에 레티놀과 베타카로틴도 비타민A의 역할을 하므로 주의해야 한다. </p>
                <a class="btn btn-primary float-xl-end" href="#">더보기</a>
            </div>
        </div>
        <!-- /Main Contents -->
